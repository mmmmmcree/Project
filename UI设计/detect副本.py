...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'best_gray.pt', help='model path or triton URL')
    ...
    parser.add_argument('--project', default=ROOT / 'D:/YOLOv5_7.0/runs/detect', help='save results to project/name')
    parser.add_argument('--name', default='exp0', help='save results to project/name')
